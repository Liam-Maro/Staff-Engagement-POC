...
class CreateTaskRequestValidationTest {
    ...
    void nullIndividualId_shouldProduceViolation() {
        var request = new CreateTaskRequest(null, null, UUID.randomUUID(), "Description", null);
    ...
    void nullAssigneeId_shouldProduceViolation() {
        var request = new CreateTaskRequest(UUID.randomUUID(), null, null, "Description", null);
    ...
    void nullDescription_shouldProduceViolation() {
        var request = new CreateTaskRequest(UUID.randomUUID(), null, UUID.randomUUID(), null, null);
    ...
    void emptyDescription_shouldProduceViolation() {
        var request = new CreateTaskRequest(UUID.randomUUID(), null, UUID.randomUUID(), "", null);
    ...
    void whitespaceOnlyDescription_shouldProduceViolation() {
        var request = new CreateTaskRequest(UUID.randomUUID(), null, UUID.randomUUID(), "   \t\n  ", null);
    ...
    void descriptionExceeding2000Characters_shouldProduceViolation() {
        ...
        var request = new CreateTaskRequest(UUID.randomUUID(), null, UUID.randomUUID(), oversized, null);
    ...
    void descriptionExactly2000Characters_shouldPassValidation() {
        ...
        var request = new CreateTaskRequest(UUID.randomUUID(), null, UUID.randomUUID(), exact, null);
    ...
    void multipleInvalidFields_shouldProduceMultipleViolations() {
        // null individualId, null assigneeId, blank description — 3 violations minimum
        var request = new CreateTaskRequest(null, null, null, "", null);
    ...
    void allNullFields_shouldProduceMultipleViolations() {
        // null individualId, null assigneeId, null description
        var request = new CreateTaskRequest(null, null, null, null, null);
